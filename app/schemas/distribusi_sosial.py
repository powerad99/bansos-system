"""Schemas untuk Distribusi Sosial (Fakir Miskin, Disabilitas, Anak Yatim Piatu)."""
from datetime import datetime
from typing import List, Optional

from pydantic import BaseModel, ConfigDict, computed_field

from app.models.distribusi_sosial import StatusSosial
...
class DistribusiSosialOut(BaseModel):
    id: int
    penerima_id: int
    bulan: int
    tahun: int
...
class DistribusiSosialListResponse(BaseModel):
    total: int
    page: int
    size: int
    items: List[DistribusiSosialOut]
